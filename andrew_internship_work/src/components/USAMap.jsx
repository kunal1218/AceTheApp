...
export default function USAMap() {
  ...
  {/*const capitals = [
    { id: 'AL', name: 'Montgomery', x: 748, y: 388 },
    { id: 'AK', name: 'Juneau', x: 279, y: 510 },
    { id: 'AZ', name: 'Phoenix', x: 308, y: 361 },
    { id: 'AR', name: 'Little Rock', x: 642, y: 350 },
    { id: 'CA', name: 'Sacramento', x: 180, y: 225 },
    { id: 'CO', name: 'Denver', x: 432, y: 248 },
    { id: 'CT', name: 'Hartford', x: 926, y: 146 },
    { id: 'DE', name: 'Dover', x: 898, y: 208 },
    { id: 'FL', name: 'Tallahassee', x: 788, y: 417 },
    { id: 'GA', name: 'Atlanta', x: 781, y: 348 },
    { id: 'HI', name: 'Honolulu', x: 372, y: 475 },
    { id: 'ID', name: 'Boise', x: 277, y: 150 },
    { id: 'IL', name: 'Springfield', x: 670, y: 236 },
    { id: 'IN', name: 'Indianapolis', x: 729, y: 231 },
    { id: 'IA', name: 'Des Moines', x: 615, y: 212 },
    { id: 'KS', name: 'Topeka', x: 575, y: 262 },
    { id: 'KY', name: 'Frankfort', x: 755, y: 261 },
    { id: 'LA', name: 'Baton Rouge', x: 668, y: 435 },
    { id: 'ME', name: 'Augusta', x: 950, y: 83 },
    { id: 'MD', name: 'Annapolis', x: 883, y: 214 },
    { id: 'MA', name: 'Boston', x: 941, y: 123 },
    { id: 'MI', name: 'Lansing', x: 742, y: 161 },
    { id: 'MN', name: 'Saint Paul', x: 615, y: 134 },
    { id: 'MS', name: 'Jackson', x: 680, y: 395 },
    { id: 'MO', name: 'Jefferson City', x: 644, y: 264 },
    { id: 'MT', name: 'Helena', x: 347, y: 98 },
    { id: 'NE', name: 'Lincoln', x: 560, y: 224 },
    { id: 'NV', name: 'Carson City', x: 221, y: 221 },
    { id: 'NH', name: 'Concord', x: 935, y: 111 },
    { id: 'NJ', name: 'Trenton', x: 903, y: 184 },
    { id: 'NM', name: 'Santa Fe', x: 412, y: 330 },
    { id: 'NY', name: 'Albany', x: 894, y: 127 },
    { id: 'NC', name: 'Raleigh', x: 863, y: 289 },
    { id: 'ND', name: 'Bismarck', x: 514, y: 105 },
    { id: 'OH', name: 'Columbus', x: 779, y: 224 },
    { id: 'OK', name: 'Oklahoma City', x: 553, y: 330 },
    { id: 'OR', name: 'Salem', x: 190, y: 104 },
    { id: 'PA', name: 'Harrisburg', x: 867, y: 191 },
    { id: 'RI', name: 'Providence', x: 943, y: 140 },
    { id: 'SC', name: 'Columbia', x: 833, y: 331 },
    { id: 'SD', name: 'Pierre', x: 514, y: 144 },
    { id: 'TN', name: 'Nashville', x: 734, y: 734 },
    { id: 'TX', name: 'Austin', x: 553, y: 434 },
    { id: 'UT', name: 'Salt Lake City', x: 327, y: 215 },
    { id: 'VT', name: 'Montpelier', x: 911, y: 93 },
    { id: 'VA', name: 'Richmond', x: 876, y: 245 },
    { id: 'WA', name: 'Olympia', x: 203, y: 57 },
    { id: 'WV', name: 'Charleston', x: 813, y: 236 },
    { id: 'WI', name: 'Madison', x: 674, y: 170 },
